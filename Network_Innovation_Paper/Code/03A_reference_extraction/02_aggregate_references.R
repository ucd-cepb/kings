...
refs <- reference_compile(nip_product('03A_reference_extraction', 'extracted_references/'),cores = 9)
saveRDS(refs,nip_product('03A_reference_extraction', 'gsp_raw_references.rds'))

refs <- readRDS(nip_product('03A_reference_extraction', 'gsp_raw_references.rds'))
...
saveRDS(clean_dt,nip_product('03A_reference_extraction', 'gsp_clean_unclassified_refs.rds'))


clean_dt <- readRDS(nip_product('03A_reference_extraction', 'gsp_clean_unclassified_refs.rds'))
...
saveRDS(cls,nip_product('03A_reference_extraction', 'gsp_classified_refs.rds'))
