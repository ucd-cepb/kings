...
oa_candidates <- readRDS(nip_product('03A_reference_extraction', 'gsp_openalex_title_results.rds'))
...
saveRDS(results,nip_product('03A_reference_extraction', 'gsp_solr_OA_matches.rds'))
system('solr stop')
