...
#' 
#### TO DO: BREAK THIS DOWN BY SECTION -- I.E., WE WANT TO FOCUS ON HASING THE MOST TECHNICAL SECTION
### BUT: IS THERE A CONTEXT SECTION WE WANT TO VECTORIZE AND CODE AS A CONTROL??
...
log_message(paste("Loaded", nrow(documents), "pages from", length(unique(documents$gsp_id)), "GSP documents"))
