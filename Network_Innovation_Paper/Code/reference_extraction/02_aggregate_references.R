...
refs <- reference_compile('Network_Innovation_Paper/data_products/extracted_references/',cores = 9)
saveRDS(refs,'Network_Innovation_Paper/data_products/gsp_raw_references.rds')

refs <- readRDS('Network_Innovation_Paper/data_products/gsp_raw_references.rds')
...
saveRDS(clean_dt,'Network_Innovation_Paper/data_products/gsp_clean_unclassified_refs.rds')


clean_dt <- readRDS('Network_Innovation_Paper/data_products/gsp_clean_unclassified_refs.rds')
...
saveRDS(cls,'Network_Innovation_Paper/data_products/gsp_classified_refs.rds')
