...
# exists_mod_1 <- glm(exists2~DAC+incorporated+POP_log+per_latino, 
#                     family = binomial,
#                     data = all_places)
# 
# exists_mod_2 <- glm(exists2 ~ MHI_log+incorporated+POP_log+per_latino, 
#                     family = binomial,
#                     data = all_places)
...
stargazer(exists_mod_1, exists_mod_2, exists_mod_3, exists_mod_4, type='text')
