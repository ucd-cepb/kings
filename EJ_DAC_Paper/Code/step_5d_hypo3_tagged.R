# step_5d_hypo3_tagged.R
# Hypothesis 3: Distance to Leadership
# Tests whether places are closer/farther from GSA leadership based on DAC status.
...
stargazer(lead_mod_3, lead_mod_4,
          type = "html", out = "EJ_DAC_Paper/Out/mods/h3_leaderdist_tagged.html")
