...
gsp_text_with_meta <- left_join(gsp_text_with_meta, boardsummary)
...
ggcorrplot(cor(gspmini[,c(
   "prioritynum","percent_dac_by_pop","fract_of_area_in_habitat_log_scaled",
   "log_well_MCL_exceedance_count_by_log_pop_scaled","dsci_scaled",
   "exante_collab",
   "mult_gsas","Agr_Share_Of_GDP_scaled","Republican_Vote_Share_scaled",
   "basin_population_log_scaled","board_prop_from_localgov")]
   ), lab = T)
...
summary(gsp_text_with_meta$well_MCL_exceedance_count)
