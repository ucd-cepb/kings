...
saveRDS(corrplotbypage, paste0(filekey[filekey$var_name=="stmpaper_figures",]$filepath, "/corrplotbypage"))
...
saveRDS(corrplotbygsp, paste0(filekey[filekey$var_name=="stmpaper_figures",]$filepath, "/corrplotbygsp"))
