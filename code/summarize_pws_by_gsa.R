...
gsp_inters_pws$HVIOL_PROP <- gsp_inters_pws$HEALTH_VIOL_COUNT_2014_2018*gsp_inters_pws$prop_of_pws
gsp_inters_pws$NHVIOL_PROP <- gsp_inters_pws$NONHEALTH_VIOL_COUNT_2014_2018*gsp_inters_pws$prop_of_pws
...
gsp_inters_pws %>% group_by(GSP_ID) %>% 
   summarise(
      pws_count = n(),
