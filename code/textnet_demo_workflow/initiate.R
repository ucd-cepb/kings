##### github is not good for large file storage, so this project uses a combination of Box Drive and github. Just about everything is in github, except for the /data subdirectory
