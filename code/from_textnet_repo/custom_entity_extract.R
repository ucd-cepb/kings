...
custom_entity_extract <- function (x, concatenator = "_",file_ext) {
  ### flagging this -- we probably don't wnat this bheavior long term
  # but function doensn't work rightnow if these two subdirectories don't exist
  dir.create('data/nodelist')
  dir.create('data/edgelist')
